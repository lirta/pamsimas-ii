                        ...
                        <div class="ibox-content">
                          ...
                          while($kolom=mysqli_fetch_assoc($hasil))
                          {
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                      <a href='kategori_edit.php?id=$kolom[kategori_id]'  class='btn btn-primary'><i class='fa fa-pencil'></i></a>
                                      <a href='kategori_hapus.php?id=$kolom[kategori_id]' onclick=\"return confirm('Apakah anda yakin akan menghapus :)\" class='btn btn-danger'><i class='fa fa-times'></i></a> 
