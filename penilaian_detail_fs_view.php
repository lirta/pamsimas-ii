            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                         <?php
                                    $queri = "SELECT * FROM penilaian inner join pegawai on penilaian.penilai_id=pegawai.pegawai_id WHERE penilaian_id='$_GET[id]'";
                    ...
                    <tr>
                        <th>SATKER</th>
                        <th><?php  echo "$data[pegawai_nama]"; ?></th>
                    </tr>
                    </tfoot>
                    </table>
...
<?php }else{ include "penilaian_detail_view.php";} }; ?>
